...
public class faceExpressionRecognition {
    ...
    //EK EK LINE OF CODE PADH K SAMJHNA JAISE SET NUMBER OF THREADS
    //COMMENTS DEKH K PATA LAG JAAYEGA KI VIDEO SE KIYA HAI
    //ITNA SAARA CODE REPEATED HAI ....CLEAN CODE
    ...
    faceExpressionRecognition(AssetManager assetManager, Context context, String modelPath, int inputSize)
            throws IOException {
