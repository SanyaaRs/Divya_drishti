        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                if (mVoiceInputTv.getText().toString().contains("bank transfer")) {
                    Intent i = new Intent(MainActivity7.this,Banktransfer.class);
                    startActivity(i);
                }
                else if(mVoiceInputTv.getText().toString().contains("phone transfer")){
                    Intent i = new Intent(MainActivity7.this,phonetransfer.class);
                    startActivity(i);
                }

                if (mVoiceInputTv.getText().toString().contains("object detection")) {
                    Intent i = new Intent(MainActivity7.this, ObjectDetection.class);
                    startActivity(i);
                }
