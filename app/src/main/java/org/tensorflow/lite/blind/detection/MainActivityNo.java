...
public class MainActivityNo extends AppCompatActivity {
    static {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainActivityNo.this,EmotionDetectionActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        camera_button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivityNo.this,RealTimeFaceRecognitionActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
    ...
    public boolean onTouchEvent(MotionEvent touchEvent) {
        ...
        switch (touchEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (x1 < x2) {
                    firstTime = 1;
                    Intent intent = new Intent(MainActivityNo.this, MainActivity.class);
    ...
    if (mVoiceInputTv.getText().toString().contains("bank transfer")) {
                    Intent i = new Intent(MainActivityNo.this,Banktransfer.class);
                    startActivity(i);
                }
                else if(mVoiceInputTv.getText().toString().contains("phone transfer")){
                    Intent i = new Intent(MainActivityNo.this,phonetransfer.class);
                    startActivity(i);
                } else {
                    textToSpeech.speak("Do not understand just Swipe right Say again", TextToSpeech.QUEUE_FLUSH, null);
                }
                 if (mVoiceInputTv.getText().toString().contains("object detection")) {
                 Intent i = new Intent(MainActivityNo.this,ObjectDetection.class);
                 startActivity(i);
                }

                if (mVoiceInputTv.getText().toString().contains("currency detection")) {
                    Intent i = new Intent(MainActivityNo.this,ClassifierActivity.class);
                    startActivity(i);
                }
